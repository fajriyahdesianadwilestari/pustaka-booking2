        ...
        <div class="row">
            <div class="col-sm-9 col-md-6">
                <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%;">
                    ...
                    <div class="caption">
                        <h5 style="min-height:60px;" align="center"><?= $pengarang ?></h5>
                        <center>
                        ...
                        <p>
                            <a class="btn btn-outline-primary" href="<?= base_url('booking/tambahBooking/' . $id); ?>">
                                <i class="fas fa-shopping-cart"></i> Booking
                            </a>
                            <span class="btn btn-outline-secondary" onclick="window.history.go(-1)"></i> Kembali</span>
                        </p>
                    </div>
                </div>
            </div>
